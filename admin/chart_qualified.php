...
if (isset($_SESSION["user_level"])) {
  require '../db.php';
  $quali = "SELECT COUNT(*) AS total FROM students WHERE remarks = 'Qualified' ";
  $unquali = "SELECT COUNT(*) AS total FROM students WHERE remarks = 'Unqualified' ";
  $qualified = mysqli_query($conn,$quali);
  $qfetch  =mysqli_fetch_assoc($qualified);
  $q_rows = $qfetch['total'];
  $unqualified = mysqli_query($conn,$unquali);
