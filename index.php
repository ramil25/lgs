	...
	<div class="header-first-bar">
		...
		<div class="header-limiter">
			...
			<nav>
				...
				<a href="students/result.php" style="margin-right: 30px;">Results</a>
				<a href="students/req_moral.php" style="margin-right: 30px;">Request Good Moral</a>
				<a href="students/aboutus.php" style="margin-right: 30px;">About Us</a>
			</nav>
